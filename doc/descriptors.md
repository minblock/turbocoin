# Support for Output Descriptors in Turbocoins Core

Since Turbocoins Core v0.17, there is support for Output Descriptors. This is a
...
on Turbocoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Turbocoins Core wallets, a convenience function `combo` is
