...
{
    const char* pszTimestamp = "4/2/2020 Provigen Networks: Dacetta Flyson 3 or 4";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586012797, 713019, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xef168fc8113cdfaeca8c6f947a895fbc0f39ddcfd8ab1083b9e21abb34cf714c"));
        assert(genesis.hashMerkleRoot == uint256S("0xff68d85c88518a90b32439c5a6c977c979e098265f0189dbe29c9af57f17b9a9"));
        ...
        vSeeds.emplace_back("seed-a.turbocoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.turbocoinstools.com");
        vSeeds.emplace_back("dnsseed.turbocoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 980490, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x09878737fba73310bba30411988e406cbd0c90e6bc0ae5e09c95341f1eea7986"));
        assert(genesis.hashMerkleRoot == uint256S("0xff68d85c88518a90b32439c5a6c977c979e098265f0189dbe29c9af57f17b9a9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.turbocoinstools.com");
        vSeeds.emplace_back("seed-b.turbocoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x50341d91d3a9d3246d0cf9056ba35adce3bef16b877be897602634bf7b80ff73"));
        assert(genesis.hashMerkleRoot == uint256S("0xff68d85c88518a90b32439c5a6c977c979e098265f0189dbe29c9af57f17b9a9"));
