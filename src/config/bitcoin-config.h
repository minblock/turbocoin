...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Turbocoins Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Turbocoins Core"
...
#define PACKAGE_BUGREPORT "https://github.com/turbocoins-project/turbocoins/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Turbocoins Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Turbocoins Core 0.18.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "turbocoins"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://turbocoins.org/"
