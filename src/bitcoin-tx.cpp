...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " turbocoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  turbocoins-tx [options] <hex-tx> [commands]  Update hex-encoded turbocoins transaction\n" +
            "or:     turbocoins-tx [options] -create [commands]   Create hex-encoded turbocoins transaction\n" +
            "\n";
