...
"""Verify that starting turbocoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start turbocoins with -h for help text")
        ...
        self.log.info("Start turbocoins with -version for version information")
        ...
        self.log.info("Start turbocoinsd with -fakearg to make sure it does not start")
